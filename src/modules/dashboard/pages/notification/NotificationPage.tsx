...
const NotificationPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-orange-50/30 to-white px-4 py-10 text-slate-900 sm:px-6 lg:px-10">
      <div className="mx-auto w-full max-w-[1700px] space-y-8">
        <section className="rounded-3xl border border-orange-100/70 bg-white/80 p-8 shadow-xl ring-1 ring-orange-100/40 backdrop-blur">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-2xl">
              ...
              <p className="mt-3 text-base text-slate-500">
                Quản lý và theo dõi tất cả thông báo trong một không gian duy nhất, để có phản hồi nhanh chóng.
              </p>
            </div>
        ...
        <div className="grid gap-6 xl:grid-cols-[360px_minmax(0,1fr)] 2xl:grid-cols-[420px_minmax(0,1fr)]">
            ...
            <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              <div className="flex flex-col gap-4">
                <div className="flex items-center justify-between">
                  <p className="text-sm font-semibold text-slate-600">Tổng {filteredNotifications.length} thông báo</p>
                ...
                <p className="text-xs text-slate-500">
                  Hãy chọn nhiều thông báo để thực hiện thao tác như - đánh dấu đã đọc hoặc xóa với một thao tác duy nhất.
                </p>
              </div>
            </section>
          </div>
          ...
          <div className="space-y-6">
            <section className="rounded-3xl border border-slate-200 bg-white p-2 shadow-sm sm:p-4">
              <div ref={listRef} className="max-h-[620px] space-y-4 overflow-y-auto pr-1 scrollbar-thin sm:pr-2">
                {loading ? (
